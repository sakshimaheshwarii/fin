...
const appRoutes: Routes = [
  ...
  { path: 'new-loan', component: LoanApplicationComponent,canActivate: [AuthGuard] },
  { path: 'loan-status', component: LoanStatusComponent,canActivate: [AuthGuard] },
  { path: 'resolve-issues', component: IssueResolutionComponent ,canActivate: [AuthGuard]},
  { path: 'loan-calculator', component: LoanCalculatorComponent,canActivate: [AuthGuard] },
  { path: 'admin/user-management', component: UserManagementComponent,canActivate: [AuthGuard] },
  { path: 'admin/loan-applications', component: LoanApplicationComponent,canActivate: [AuthGuard] },
  { path: 'admin/pending-approvals', component: LoanPendingApprovalsComponent ,canActivate: [AuthGuard]},
  { path: 'admin/issues/common-solution', component: CommonissuesolutionComponent ,canActivate: [AuthGuard]},
  { path: 'admin/loan-list', component: LoanListComponent,canActivate: [AuthGuard] },
  { path: 'user/user-score', component: ScoreComponent ,canActivate: [AuthGuard]},
