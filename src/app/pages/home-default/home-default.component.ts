...
export class HomeDefaultComponent implements OnInit {
  ...
  features = [
    {
      icon: 'trending_up', // Material icon for Financial Planning
    ...
    {
      icon: 'attach_money', // Material icon for Loan Services
      title: 'Loan Services',
    ...
    {
      icon: 'security', // Material icon for Secure Solutions
